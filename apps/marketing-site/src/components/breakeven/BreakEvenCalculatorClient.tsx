                ...
                <ResponsiveContainer width="100%" height={320}>
                  <LineChart data={chartData} margin={{ top: 10, right: 15, left: -10, bottom: 15 }}>
                    ...
                    <XAxis
                      ...
                      tickFormatter={(val) => businessModel === "retail-margin" ? chartCurrencyFormat(val) : `${val}`}
                      label={{
                    ...
                    <Tooltip
                      ...
                      labelFormatter={(label) => `${businessModel === "retail-margin" ? t.storeTurnover : t.unitsSold}: ${businessModel === "retail-margin" ? formatCurrency(Number(label)) : label}`}
                      contentStyle={{
                        background: "#1E293B",
                    ...
                    <ReferenceDot
                      ...
                      r={6}
                      fill={businessModel === "retail-margin" ? "#10b981" : businessModel === "multi-mix" ? "#d97706" : "#4f46e5"}
                      stroke="#ffffff"
                      strokeWidth={2.5}
                    />
                  </LineChart>
